...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const menuItems = [
    ...
    {
      path: '/app/rasna-entries',
      icon: ClipboardPenLine,
      label: 'Rasna Entries',
      show: isManufacturer || isAdmin
    },
    {
      path: '/app/rasna-customer-summary',
      icon: User,
      label: 'Rasna Customer Summary',
      show: isManufacturer || isAdmin
    },

    {
      path: '/app/pio-entries',
      icon: ClipboardPenLine,
      label: 'PIO Entries',
      show: isManufacturer || isAdmin
    },
    {
      path: '/app/pio-customer-summary',
      icon: User,
      label: 'PIO Customer Summary',
      show: isManufacturer || isAdmin
    },
    ...
    >
      ...
      <div className="p-4 border-b border-theme-border flex items-center justify-between">
        ...
        <button
          ...
          className="lg:hidden text-theme-muted hover:text-primary-400"
